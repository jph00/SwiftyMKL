...
extension BaseVector {
  ...
  @inlinable public func acos(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].acos() }
  }
  ...
  @inlinable public func acosh(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].acosh() }
  }
  ...
  @inlinable public func asin(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].asin() }
  }
  ...
  @inlinable public func asinh(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].asinh() }
  }
  ...
  @inlinable public func atan(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].atan() }
  }
  ...
  @inlinable public func atanh(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].atanh() }
  }
  ...
  @inlinable public func cbrt(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].cbrt() }
  }
  ...
  @inlinable public func cos(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].cos() }
  }
  ...
  @inlinable public func cosh(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].cosh() }
  }
  ...
  @inlinable public func erf(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].erf() }
  }
  ...
  @inlinable public func erfc(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].erfc() }
  }
  ...
  @inlinable public func exp(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].exp() }
  }
  ...
  @inlinable public func exp2(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].exp2() }
  }
  ...
  @inlinable public func expm1(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].expm1() }
  }
  ...
  @inlinable public func log(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].log() }
  }
  ...
  @inlinable public func log10(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].log10() }
  }
  ...
  @inlinable public func log1p(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].log1p() }
  }
  ...
  @inlinable public func log2(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].log2() }
  }
  ...
  @inlinable public func logb(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].logb() }
  }
  ...
  @inlinable public func nearbyint(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].nearbyint() }
  }
  ...
  @inlinable public func rint(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].rint() }
  }
  ...
  @inlinable public func sin(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].sin() }
  }
  ...
  @inlinable public func sinh(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].sinh() }
  }
  ...
  @inlinable public func tan(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].tan() }
  }
  ...
  @inlinable public func tanh(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].tanh() }
  }
  ...
  @inlinable public func tgamma(_ dest:Self) {
    let pDst=dest.p; let ptr=p
    for i in 0..<count { pDst[i] = ptr[i].tgamma() }
  }
