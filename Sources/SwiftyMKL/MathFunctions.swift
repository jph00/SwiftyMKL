...
public protocol SupportsMKL:BinaryFloatingPoint {
  ...
  static func dot(_ N:Int, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int)->T
  static func doti(_ N:Int, _ X:PtrT, _ indx:UnsafePointer<Int32>, _ Y:PtrT)->T
  static func nrm2(_ N:Int, _ X:PtrT, _ incX:Int)->T
  static func asum(_ N:Int, _ X:PtrT, _ incX:Int)->T
  ...
  static func axpy(_ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:MutPtrT, _ incY:Int)
  static func axpby(_ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int)
  static func axpyi(_ N:Int, _ alpha:T, _ X:PtrT, _ indx:UnsafePointer<Int32>, _ Y:MutPtrT)
  ...
  static func rot(_ N:Int, _ X:MutPtrT, _ incX:Int, _ Y:MutPtrT, _ incY:Int, _ c:T, _ s:T)
  static func roti(_ N:Int, _ X:MutPtrT, _ indx:UnsafePointer<Int32>, _ Y:MutPtrT, _ c:T, _ s:T)
  static func rotm(_ N:Int, _ X:MutPtrT, _ incX:Int, _ Y:MutPtrT, _ incY:Int, _ P:PtrT)
  static func scal(_ N:Int, _ alpha:T, _ X:MutPtrT, _ incX:Int)
  static func gemv(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int)
  static func gbmv(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ KL:Int, _ KU:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int)
  ...
  static func symv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int)
  static func sbmv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int)
  static func spmv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ Ap:PtrT, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int)
  static func ger(_ Layout:CBLAS_LAYOUT, _ M:Int, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT, _ lda:Int)
  static func syr(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ A:MutPtrT, _ lda:Int)
  static func spr(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Ap:MutPtrT)
  static func syr2(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT, _ lda:Int)
  static func spr2(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT)
  static func gemm(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ TransB:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int)
  static func gemmt(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ TransB:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int)
  static func symm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int)
  static func syrk(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ Trans:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int)
  static func syr2k(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ Trans:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int)
  static func trmm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ Diag:CBLAS_DIAG, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:MutPtrT, _ ldb:Int)
  static func trsm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ Diag:CBLAS_DIAG, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:MutPtrT, _ ldb:Int)
  static func gemm_pack_get_size(_ identifier:CBLAS_IDENTIFIER, _ M:Int, _ N:Int, _ K:Int)->Int32
  static func gemm_pack(_ Layout:CBLAS_LAYOUT, _ identifier:CBLAS_IDENTIFIER, _ Trans:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ K:Int, _ alpha:T, _ src:PtrT, _ ld:Int, _ dest:MutPtrT)
  static func gemm_compute(_ Layout:CBLAS_LAYOUT, _ TransA:Int, _ TransB:Int, _ M:Int, _ N:Int, _ K:Int, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int)
  ...
  static func powx(_ n:Int, _ a:PtrT, _ b:T, _ r:MutPtrT)
  static func powr(_ n:Int, _ a:PtrT, _ b:PtrT, _ r:MutPtrT)
  static func sinCos(_ n:Int, _ a:PtrT, _ r1:MutPtrT, _ r2:MutPtrT)
  static func linearFrac(_ n:Int, _ a:PtrT, _ b:PtrT, _ scalea:T, _ shifta:T, _ scaleb:T, _ shiftb:T, _ r:MutPtrT)
  ...
  static func set(_ val:T, _ pDst:MutPtrT, _ len:Int)
  static func zero(_ pDst:MutPtrT, _ len:Int)
  static func triangle(_ pDst:MutPtrT, _ len:Int, _ magn:T, _ rFreq:T, _ asym:T, _ pPhase:MutPtrT)
  static func vectorJaehne(_ pDst:MutPtrT, _ len:Int, _ magn:T)
  static func vectorSlope(_ pDst:MutPtrT, _ len:Int, _ offset:T, _ slope:T)
  static func addC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int)
  static func add(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int)
  static func addProductC(_ pSrc:PtrT, _ val:T, _ pSrcDst:MutPtrT, _ len:Int)
  static func addProduct(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pSrcDst:MutPtrT, _ len:Int)
  static func mulC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int)
  static func mul(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int)
  static func subC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int)
  static func subCRev(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int)
  static func sub(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int)
  static func divC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int)
  ...
  static func normalize(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ vSub:T, _ vDiv:T)
  ...
  static func threshold_LT(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T)
  static func threshold_GT(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T)
  static func threshold_LTAbs(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T)
  static func threshold_GTAbs(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T)
  static func threshold_LTAbsVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T)
  static func threshold_LTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T)
  static func threshold_GTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T)
  static func threshold_LTValGTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ levelLT:T, _ valueLT:T, _ levelGT:T, _ valueGT:T)
  static func threshold_LTInv(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T)
  ...
  static func winBlackman(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ alpha:T)
  ...
  static func winKaiser(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ alpha:T)
  ...
  static func rngCauchy(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32
  static func rngUniform(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32
  static func rngGaussian(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32
  ...
  static func rngExponential(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32
  static func rngLaplace(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32
  static func rngWeibull(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T)->Int32
  static func rngRayleigh(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32
  static func rngLognormal(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T, _ d:T)->Int32
  static func rngGumbel(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32
  static func rngGamma(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T)->Int32
  static func rngBeta(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T, _ d:T)->Int32
}
...
extension Float : SupportsMKL {
  ...
  public static func dot(_ N:Int, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int)->T { return cblas_sdot(numericCast(N),X,numericCast(incX),Y,numericCast(incY)) }
  public static func doti(_ N:Int, _ X:PtrT, _ indx:UnsafePointer<Int32>, _ Y:PtrT)->T { return cblas_sdoti(numericCast(N),X,indx,Y) }
  public static func nrm2(_ N:Int, _ X:PtrT, _ incX:Int)->T { return cblas_snrm2(numericCast(N),X,numericCast(incX)) }
  public static func asum(_ N:Int, _ X:PtrT, _ incX:Int)->T { return cblas_sasum(numericCast(N),X,numericCast(incX)) }
  ...
  public static func axpy(_ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:MutPtrT, _ incY:Int) { cblas_saxpy(numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY)) }
  public static func axpby(_ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_saxpby(numericCast(N),alpha,X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func axpyi(_ N:Int, _ alpha:T, _ X:PtrT, _ indx:UnsafePointer<Int32>, _ Y:MutPtrT) { cblas_saxpyi(numericCast(N),alpha,X,indx,Y) }
  ...
  public static func rot(_ N:Int, _ X:MutPtrT, _ incX:Int, _ Y:MutPtrT, _ incY:Int, _ c:T, _ s:T) { cblas_srot(numericCast(N),X,numericCast(incX),Y,numericCast(incY),c,s) }
  public static func roti(_ N:Int, _ X:MutPtrT, _ indx:UnsafePointer<Int32>, _ Y:MutPtrT, _ c:T, _ s:T) { cblas_sroti(numericCast(N),X,indx,Y,c,s) }
  ...
  public static func scal(_ N:Int, _ alpha:T, _ X:MutPtrT, _ incX:Int) { cblas_sscal(numericCast(N),alpha,X,numericCast(incX)) }
  public static func gemv(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_sgemv(Layout,TransA,numericCast(M),numericCast(N),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func gbmv(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ KL:Int, _ KU:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_sgbmv(Layout,TransA,numericCast(M),numericCast(N),numericCast(KL),numericCast(KU),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  ...
  public static func symv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_ssymv(Layout,Uplo,numericCast(N),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func sbmv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_ssbmv(Layout,Uplo,numericCast(N),numericCast(K),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func spmv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ Ap:PtrT, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_sspmv(Layout,Uplo,numericCast(N),alpha,Ap,X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func ger(_ Layout:CBLAS_LAYOUT, _ M:Int, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT, _ lda:Int) { cblas_sger(Layout,numericCast(M),numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY),A,numericCast(lda)) }
  public static func syr(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ A:MutPtrT, _ lda:Int) { cblas_ssyr(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),A,numericCast(lda)) }
  public static func spr(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Ap:MutPtrT) { cblas_sspr(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),Ap) }
  public static func syr2(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT, _ lda:Int) { cblas_ssyr2(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY),A,numericCast(lda)) }
  public static func spr2(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT) { cblas_sspr2(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY),A) }
  public static func gemm(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ TransB:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_sgemm(Layout,TransA,TransB,numericCast(M),numericCast(N),numericCast(K),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func gemmt(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ TransB:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_sgemmt(Layout,Uplo,TransA,TransB,numericCast(N),numericCast(K),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func symm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_ssymm(Layout,Side,Uplo,numericCast(M),numericCast(N),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func syrk(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ Trans:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_ssyrk(Layout,Uplo,Trans,numericCast(N),numericCast(K),alpha,A,numericCast(lda),beta,C,numericCast(ldc)) }
  public static func syr2k(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ Trans:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_ssyr2k(Layout,Uplo,Trans,numericCast(N),numericCast(K),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func trmm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ Diag:CBLAS_DIAG, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:MutPtrT, _ ldb:Int) { cblas_strmm(Layout,Side,Uplo,TransA,Diag,numericCast(M),numericCast(N),alpha,A,numericCast(lda),B,numericCast(ldb)) }
  public static func trsm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ Diag:CBLAS_DIAG, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:MutPtrT, _ ldb:Int) { cblas_strsm(Layout,Side,Uplo,TransA,Diag,numericCast(M),numericCast(N),alpha,A,numericCast(lda),B,numericCast(ldb)) }
  ...
  public static func gemm_pack(_ Layout:CBLAS_LAYOUT, _ identifier:CBLAS_IDENTIFIER, _ Trans:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ K:Int, _ alpha:T, _ src:PtrT, _ ld:Int, _ dest:MutPtrT) { cblas_sgemm_pack(Layout,identifier,Trans,numericCast(M),numericCast(N),numericCast(K),alpha,src,numericCast(ld),dest) }
  public static func gemm_compute(_ Layout:CBLAS_LAYOUT, _ TransA:Int, _ TransB:Int, _ M:Int, _ N:Int, _ K:Int, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_sgemm_compute(Layout,numericCast(TransA),numericCast(TransB),numericCast(M),numericCast(N),numericCast(K),A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  ...
  public static func powx(_ n:Int, _ a:PtrT, _ b:T, _ r:MutPtrT) { vsPowx(numericCast(n),a,b,r) }
  ...
  public static func linearFrac(_ n:Int, _ a:PtrT, _ b:PtrT, _ scalea:T, _ shifta:T, _ scaleb:T, _ shiftb:T, _ r:MutPtrT) { vsLinearFrac(numericCast(n),a,b,scalea,shifta,scaleb,shiftb,r) }
  ...
  public static func set(_ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsSet_32f(val,pDst,numericCast(len)) }
  public static func zero(_ pDst:MutPtrT, _ len:Int) { _=ippsZero_32f(pDst,numericCast(len)) }
  public static func triangle(_ pDst:MutPtrT, _ len:Int, _ magn:T, _ rFreq:T, _ asym:T, _ pPhase:MutPtrT) { _=ippsTriangle_32f(pDst,numericCast(len),magn,rFreq,asym,pPhase) }
  public static func vectorJaehne(_ pDst:MutPtrT, _ len:Int, _ magn:T) { _=ippsVectorJaehne_32f(pDst,numericCast(len),magn) }
  public static func vectorSlope(_ pDst:MutPtrT, _ len:Int, _ offset:T, _ slope:T) { _=ippsVectorSlope_32f(pDst,numericCast(len),offset,slope) }
  public static func addC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsAddC_32f(pSrc,val,pDst,numericCast(len)) }
  public static func add(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int) { _=ippsAdd_32f(pSrc1,pSrc2,pDst,numericCast(len)) }
  public static func addProductC(_ pSrc:PtrT, _ val:T, _ pSrcDst:MutPtrT, _ len:Int) { _=ippsAddProductC_32f(pSrc,val,pSrcDst,numericCast(len)) }
  ...
  public static func mulC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsMulC_32f(pSrc,val,pDst,numericCast(len)) }
  public static func mul(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int) { _=ippsMul_32f(pSrc1,pSrc2,pDst,numericCast(len)) }
  public static func subC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsSubC_32f(pSrc,val,pDst,numericCast(len)) }
  public static func subCRev(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsSubCRev_32f(pSrc,val,pDst,numericCast(len)) }
  public static func sub(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int) { _=ippsSub_32f(pSrc1,pSrc2,pDst,numericCast(len)) }
  public static func divC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsDivC_32f(pSrc,val,pDst,numericCast(len)) }
  ...
  public static func normalize(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ vSub:T, _ vDiv:T) { _=ippsNormalize_32f(pSrc,pDst,numericCast(len),vSub,vDiv) }
  ...
  public static func threshold_LT(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_LT_32f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_GT(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_GT_32f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_LTAbs(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_LTAbs_32f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_GTAbs(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_GTAbs_32f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_LTAbsVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T) { _=ippsThreshold_LTAbsVal_32f(pSrc,pDst,numericCast(len),level,value) }
  public static func threshold_LTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T) { _=ippsThreshold_LTVal_32f(pSrc,pDst,numericCast(len),level,value) }
  public static func threshold_GTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T) { _=ippsThreshold_GTVal_32f(pSrc,pDst,numericCast(len),level,value) }
  public static func threshold_LTValGTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ levelLT:T, _ valueLT:T, _ levelGT:T, _ valueGT:T) { _=ippsThreshold_LTValGTVal_32f(pSrc,pDst,numericCast(len),levelLT,valueLT,levelGT,valueGT) }
  public static func threshold_LTInv(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_LTInv_32f(pSrc,pDst,numericCast(len),level) }
  ...
  public static func winBlackman(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ alpha:T) { _=ippsWinBlackman_32f(pSrc,pDst,numericCast(len),alpha) }
  ...
  public static func winKaiser(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ alpha:T) { _=ippsWinKaiser_32f(pSrc,pDst,numericCast(len),alpha) }
  ...
  public static func rngCauchy(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vsRngCauchy(method,stream,numericCast(n),r,a,b) }
  public static func rngUniform(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vsRngUniform(method,stream,numericCast(n),r,a,b) }
  public static func rngGaussian(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vsRngGaussian(method,stream,numericCast(n),r,a,b) }
  ...
  public static func rngExponential(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vsRngExponential(method,stream,numericCast(n),r,a,b) }
  public static func rngLaplace(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vsRngLaplace(method,stream,numericCast(n),r,a,b) }
  public static func rngWeibull(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T)->Int32 { return vsRngWeibull(method,stream,numericCast(n),r,a,b,c) }
  public static func rngRayleigh(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vsRngRayleigh(method,stream,numericCast(n),r,a,b) }
  public static func rngLognormal(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T, _ d:T)->Int32 { return vsRngLognormal(method,stream,numericCast(n),r,a,b,c,d) }
  public static func rngGumbel(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vsRngGumbel(method,stream,numericCast(n),r,a,b) }
  public static func rngGamma(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T)->Int32 { return vsRngGamma(method,stream,numericCast(n),r,a,b,c) }
  public static func rngBeta(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T, _ d:T)->Int32 { return vsRngBeta(method,stream,numericCast(n),r,a,b,c,d) }
}
extension Double : SupportsMKL {
  ...
  public static func dot(_ N:Int, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int)->T { return cblas_ddot(numericCast(N),X,numericCast(incX),Y,numericCast(incY)) }
  public static func doti(_ N:Int, _ X:PtrT, _ indx:UnsafePointer<Int32>, _ Y:PtrT)->T { return cblas_ddoti(numericCast(N),X,indx,Y) }
  public static func nrm2(_ N:Int, _ X:PtrT, _ incX:Int)->T { return cblas_dnrm2(numericCast(N),X,numericCast(incX)) }
  public static func asum(_ N:Int, _ X:PtrT, _ incX:Int)->T { return cblas_dasum(numericCast(N),X,numericCast(incX)) }
  ...
  public static func axpy(_ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:MutPtrT, _ incY:Int) { cblas_daxpy(numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY)) }
  public static func axpby(_ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_daxpby(numericCast(N),alpha,X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func axpyi(_ N:Int, _ alpha:T, _ X:PtrT, _ indx:UnsafePointer<Int32>, _ Y:MutPtrT) { cblas_daxpyi(numericCast(N),alpha,X,indx,Y) }
  ...
  public static func rot(_ N:Int, _ X:MutPtrT, _ incX:Int, _ Y:MutPtrT, _ incY:Int, _ c:T, _ s:T) { cblas_drot(numericCast(N),X,numericCast(incX),Y,numericCast(incY),c,s) }
  public static func roti(_ N:Int, _ X:MutPtrT, _ indx:UnsafePointer<Int32>, _ Y:MutPtrT, _ c:T, _ s:T) { cblas_droti(numericCast(N),X,indx,Y,c,s) }
  ...
  public static func scal(_ N:Int, _ alpha:T, _ X:MutPtrT, _ incX:Int) { cblas_dscal(numericCast(N),alpha,X,numericCast(incX)) }
  public static func gemv(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_dgemv(Layout,TransA,numericCast(M),numericCast(N),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func gbmv(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ KL:Int, _ KU:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_dgbmv(Layout,TransA,numericCast(M),numericCast(N),numericCast(KL),numericCast(KU),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  ...
  public static func symv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_dsymv(Layout,Uplo,numericCast(N),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func sbmv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_dsbmv(Layout,Uplo,numericCast(N),numericCast(K),alpha,A,numericCast(lda),X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func spmv(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ Ap:PtrT, _ X:PtrT, _ incX:Int, _ beta:T, _ Y:MutPtrT, _ incY:Int) { cblas_dspmv(Layout,Uplo,numericCast(N),alpha,Ap,X,numericCast(incX),beta,Y,numericCast(incY)) }
  public static func ger(_ Layout:CBLAS_LAYOUT, _ M:Int, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT, _ lda:Int) { cblas_dger(Layout,numericCast(M),numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY),A,numericCast(lda)) }
  public static func syr(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ A:MutPtrT, _ lda:Int) { cblas_dsyr(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),A,numericCast(lda)) }
  public static func spr(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Ap:MutPtrT) { cblas_dspr(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),Ap) }
  public static func syr2(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT, _ lda:Int) { cblas_dsyr2(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY),A,numericCast(lda)) }
  public static func spr2(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ N:Int, _ alpha:T, _ X:PtrT, _ incX:Int, _ Y:PtrT, _ incY:Int, _ A:MutPtrT) { cblas_dspr2(Layout,Uplo,numericCast(N),alpha,X,numericCast(incX),Y,numericCast(incY),A) }
  public static func gemm(_ Layout:CBLAS_LAYOUT, _ TransA:CBLAS_TRANSPOSE, _ TransB:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_dgemm(Layout,TransA,TransB,numericCast(M),numericCast(N),numericCast(K),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func gemmt(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ TransB:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_dgemmt(Layout,Uplo,TransA,TransB,numericCast(N),numericCast(K),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func symm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_dsymm(Layout,Side,Uplo,numericCast(M),numericCast(N),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func syrk(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ Trans:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_dsyrk(Layout,Uplo,Trans,numericCast(N),numericCast(K),alpha,A,numericCast(lda),beta,C,numericCast(ldc)) }
  public static func syr2k(_ Layout:CBLAS_LAYOUT, _ Uplo:CBLAS_UPLO, _ Trans:CBLAS_TRANSPOSE, _ N:Int, _ K:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_dsyr2k(Layout,Uplo,Trans,numericCast(N),numericCast(K),alpha,A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  public static func trmm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ Diag:CBLAS_DIAG, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:MutPtrT, _ ldb:Int) { cblas_dtrmm(Layout,Side,Uplo,TransA,Diag,numericCast(M),numericCast(N),alpha,A,numericCast(lda),B,numericCast(ldb)) }
  public static func trsm(_ Layout:CBLAS_LAYOUT, _ Side:CBLAS_SIDE, _ Uplo:CBLAS_UPLO, _ TransA:CBLAS_TRANSPOSE, _ Diag:CBLAS_DIAG, _ M:Int, _ N:Int, _ alpha:T, _ A:PtrT, _ lda:Int, _ B:MutPtrT, _ ldb:Int) { cblas_dtrsm(Layout,Side,Uplo,TransA,Diag,numericCast(M),numericCast(N),alpha,A,numericCast(lda),B,numericCast(ldb)) }
  ...
  public static func gemm_pack(_ Layout:CBLAS_LAYOUT, _ identifier:CBLAS_IDENTIFIER, _ Trans:CBLAS_TRANSPOSE, _ M:Int, _ N:Int, _ K:Int, _ alpha:T, _ src:PtrT, _ ld:Int, _ dest:MutPtrT) { cblas_dgemm_pack(Layout,identifier,Trans,numericCast(M),numericCast(N),numericCast(K),alpha,src,numericCast(ld),dest) }
  public static func gemm_compute(_ Layout:CBLAS_LAYOUT, _ TransA:Int, _ TransB:Int, _ M:Int, _ N:Int, _ K:Int, _ A:PtrT, _ lda:Int, _ B:PtrT, _ ldb:Int, _ beta:T, _ C:MutPtrT, _ ldc:Int) { cblas_dgemm_compute(Layout,numericCast(TransA),numericCast(TransB),numericCast(M),numericCast(N),numericCast(K),A,numericCast(lda),B,numericCast(ldb),beta,C,numericCast(ldc)) }
  ...
  public static func powx(_ n:Int, _ a:PtrT, _ b:T, _ r:MutPtrT) { vdPowx(numericCast(n),a,b,r) }
  ...
  public static func linearFrac(_ n:Int, _ a:PtrT, _ b:PtrT, _ scalea:T, _ shifta:T, _ scaleb:T, _ shiftb:T, _ r:MutPtrT) { vdLinearFrac(numericCast(n),a,b,scalea,shifta,scaleb,shiftb,r) }
  ...
  public static func set(_ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsSet_64f(val,pDst,numericCast(len)) }
  public static func zero(_ pDst:MutPtrT, _ len:Int) { _=ippsZero_64f(pDst,numericCast(len)) }
  public static func triangle(_ pDst:MutPtrT, _ len:Int, _ magn:T, _ rFreq:T, _ asym:T, _ pPhase:MutPtrT) { _=ippsTriangle_64f(pDst,numericCast(len),magn,rFreq,asym,pPhase) }
  public static func vectorJaehne(_ pDst:MutPtrT, _ len:Int, _ magn:T) { _=ippsVectorJaehne_64f(pDst,numericCast(len),magn) }
  public static func vectorSlope(_ pDst:MutPtrT, _ len:Int, _ offset:T, _ slope:T) { _=ippsVectorSlope_64f(pDst,numericCast(len),offset,slope) }
  public static func addC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsAddC_64f(pSrc,val,pDst,numericCast(len)) }
  public static func add(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int) { _=ippsAdd_64f(pSrc1,pSrc2,pDst,numericCast(len)) }
  public static func addProductC(_ pSrc:PtrT, _ val:T, _ pSrcDst:MutPtrT, _ len:Int) { _=ippsAddProductC_64f(pSrc,val,pSrcDst,numericCast(len)) }
  ...
  public static func mulC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsMulC_64f(pSrc,val,pDst,numericCast(len)) }
  public static func mul(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int) { _=ippsMul_64f(pSrc1,pSrc2,pDst,numericCast(len)) }
  public static func subC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsSubC_64f(pSrc,val,pDst,numericCast(len)) }
  public static func subCRev(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsSubCRev_64f(pSrc,val,pDst,numericCast(len)) }
  public static func sub(_ pSrc1:PtrT, _ pSrc2:PtrT, _ pDst:MutPtrT, _ len:Int) { _=ippsSub_64f(pSrc1,pSrc2,pDst,numericCast(len)) }
  public static func divC(_ pSrc:PtrT, _ val:T, _ pDst:MutPtrT, _ len:Int) { _=ippsDivC_64f(pSrc,val,pDst,numericCast(len)) }
  ...
  public static func normalize(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ vSub:T, _ vDiv:T) { _=ippsNormalize_64f(pSrc,pDst,numericCast(len),vSub,vDiv) }
  ...
  public static func threshold_LT(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_LT_64f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_GT(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_GT_64f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_LTAbs(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_LTAbs_64f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_GTAbs(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_GTAbs_64f(pSrc,pDst,numericCast(len),level) }
  public static func threshold_LTAbsVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T) { _=ippsThreshold_LTAbsVal_64f(pSrc,pDst,numericCast(len),level,value) }
  public static func threshold_LTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T) { _=ippsThreshold_LTVal_64f(pSrc,pDst,numericCast(len),level,value) }
  public static func threshold_GTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T, _ value:T) { _=ippsThreshold_GTVal_64f(pSrc,pDst,numericCast(len),level,value) }
  public static func threshold_LTValGTVal(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ levelLT:T, _ valueLT:T, _ levelGT:T, _ valueGT:T) { _=ippsThreshold_LTValGTVal_64f(pSrc,pDst,numericCast(len),levelLT,valueLT,levelGT,valueGT) }
  public static func threshold_LTInv(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ level:T) { _=ippsThreshold_LTInv_64f(pSrc,pDst,numericCast(len),level) }
  ...
  public static func winBlackman(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ alpha:T) { _=ippsWinBlackman_64f(pSrc,pDst,numericCast(len),alpha) }
  ...
  public static func winKaiser(_ pSrc:PtrT, _ pDst:MutPtrT, _ len:Int, _ alpha:T) { _=ippsWinKaiser_64f(pSrc,pDst,numericCast(len),alpha) }
  ...
  public static func rngCauchy(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vdRngCauchy(method,stream,numericCast(n),r,a,b) }
  public static func rngUniform(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vdRngUniform(method,stream,numericCast(n),r,a,b) }
  public static func rngGaussian(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vdRngGaussian(method,stream,numericCast(n),r,a,b) }
  ...
  public static func rngExponential(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vdRngExponential(method,stream,numericCast(n),r,a,b) }
  public static func rngLaplace(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vdRngLaplace(method,stream,numericCast(n),r,a,b) }
  public static func rngWeibull(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T)->Int32 { return vdRngWeibull(method,stream,numericCast(n),r,a,b,c) }
  public static func rngRayleigh(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vdRngRayleigh(method,stream,numericCast(n),r,a,b) }
  public static func rngLognormal(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T, _ d:T)->Int32 { return vdRngLognormal(method,stream,numericCast(n),r,a,b,c,d) }
  public static func rngGumbel(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T)->Int32 { return vdRngGumbel(method,stream,numericCast(n),r,a,b) }
  public static func rngGamma(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T)->Int32 { return vdRngGamma(method,stream,numericCast(n),r,a,b,c) }
  public static func rngBeta(_ method:Int32, _ stream:VSLStreamStatePtr, _ n:Int, _ r:MutPtrT, _ a:T, _ b:T, _ c:T, _ d:T)->Int32 { return vdRngBeta(method,stream,numericCast(n),r,a,b,c,d) }
}
